                ...
                <div className="h-screen flex flex-col items-center justify-center gap-[0.2rem] w-1/2">
                    ...
                    <form className='flex flex-col gap-2 w-[22rem]'>
                        ...
                        <div className="flex sm:flex-col">
                            ...
                            <input className='border-2 rounded-full py-2 px-4' name='email' required type="email" placeholder='Email' onChange={handleCredentials} />
                        </div>
                        <div className="flex sm:flex-col">
                            {/* <label className='font-bold '>Password:</label> */}
                            <input className="border-2 rounded-full py-2 px-4" name='password' required type="password" placeholder='Password' onChange={handleCredentials} />
                        </div>
                        <button onClick={handleLogin} type="submit" className="rounded-full py-2 font-bold bg-gradient-to-r from-[#032B44] via-[#205475] to-[#052F48] text-white">Log in</button>
